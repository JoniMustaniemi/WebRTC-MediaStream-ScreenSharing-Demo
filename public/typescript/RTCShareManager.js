    ...
    ConnectionManager.prototype.setEventHandlers = function (client) {
        ...
        if (client == "1") {
            ...
            this.RTCPeerConnectionObject_client_2.ontrack = function (event) {
                if (typeof _this.options.event_handlers.on_screen_receive === 'function') {
                    _this.options.event_handlers.on_screen_receive({});
                }
                _this.onReceiveScreen({
                    event: event
                });
            };
        }
...
var RTCShareManager = /** @class */ (function () {
    function RTCShareManager(options) {
        ...
        this.conMan.onReceiveScreen = function (args) {
            _this.screenSharing.receiveMedia(args.event);
        };
    }
    RTCShareManager.prototype.toggleScreenSharing = function () {
...
var ScreenSharing = /** @class */ (function () {
    function ScreenSharing(client1, client2, options) {
    ...
    ScreenSharing.prototype.getMedia = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                navigator.mediaDevices.getDisplayMedia(this.screenConstraints).then(function (stream) {
                    console.log("Sharing Screen");
                    _this.captureStream = stream;
                    _this.videoTracks = _this.captureStream.getTracks();
    ...
    ScreenSharing.prototype.attachTrackToConnection = function () {
        for (var _i = 0, _a = this.videoTracks; _i < _a.length; _i++) {
            var track = _a[_i];
            this.RTC_object_1.addTrack(track);
        }
    };
    ScreenSharing.prototype.stopMediaSharing = function () {
        var tracks = this.captureStream.getVideoTracks();
        tracks.forEach(function (track) {
            track.stop();
        });
        this.screenContainer.innerHTML = "";
    };
    ScreenSharing.prototype.receiveMedia = function (event) {
        var inboundStream = null;
        var screenPlayer = document.createElement("VIDEO");
